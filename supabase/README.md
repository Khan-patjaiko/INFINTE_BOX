...
├── migrations/            8 SQL migrations, same version stamps as supabase_migrations.schema_migrations
└── functions/
...
leaves that hash unchanged. `list_migrations` should list exactly the 8 versions in
`migrations/`.
